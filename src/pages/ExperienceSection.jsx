...
const ExperienceSection = () => {
  return (
    <div className="container">
      <div className="skill-container" style={{ animationName: 'slideInFromLeft' }}>
        <NeonCard
      ...
      <div className="skill-text" style={{ animationName: 'slideInFromRight' }}>
        <div className="skill-header">
          <div className="dash"></div>
          <h2 className="skheader-txt">WHAT I DO</h2>
        </div>
        <h1>
          Better Design <br />
          Better Experiences
        ...
        <p className="explain">
          I craft unique digital experiences by blending modern aesthetics with
          clear <br /> functionality,ensuring users enjoy a seamless interface
          across all platforms. <br /> My dedication to innovation and attention
          to detail set the stage for <br /> solutions that are not only
